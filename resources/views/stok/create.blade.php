    ...
    <script>
        ...
        function fetchProduk(search) {
            ...
            $.getJSON(url, function (result) {
                ...
                if (result.length === 0) {
                    // Jika tidak ada produk yang ditemukan, tampilkan pesan kepada pengguna
                    let row = `<tr><td colspan="3" class="text-center">Produk tidak ada.</td></tr>`;
                ...
                let row = `<tr><td colspan="3" class="text-center">Terjadi kesalahan dalam memproses permintaan.</td></tr>`;
                $('#resultProduk').append(row);
            });
        }
